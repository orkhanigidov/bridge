...
namespace engine::network {
    ...
    void ServerManager::initialize()
    {
        ...
        OATPP_LOGI("Server", "Initialized on %s:%s", connection_provider->getProperty("host").getData(), connection_provider->getProperty("port").getData());
    }
    ...
    void ServerManager::start()
    {
        ...
        OATPP_COMPONENT(std::shared_ptr<oatpp::network::ServerConnectionProvider>, connection_provider);
        OATPP_LOGI("Server", "Starting on %s:%s", connection_provider->getProperty("host").getData(), connection_provider->getProperty("port").getData());
