...
namespace codegen::generation
{
     ...
     * @param includes
     * @param classes
     * @param free_functions
     */
    void
    Sol2Generator::generate(const std::vector<std::string>& includes,
                            ...
                            const std::vector<function_descriptor>& free_functions)
    {
        ...
        write_line(out, 0, "#include \"bindings/lua/lua_binder.hpp\"", 2);
     ...
     */
    void
    Sol2Generator::write_class_registrations(const std::vector<class_descriptor>& classes, std::ofstream& out)
    {
     ...
     */
    void
    Sol2Generator::write_free_function_registrations(const std::vector<function_descriptor>& free_functions,
                                                     std::ofstream& out)
    {
     ...
     */
    void
    Sol2Generator::write_line(std::ofstream& out, int indent_level, const std::string& text, int newlines)
    {
