...
namespace engine::reflection
{
    class MethodRegistrar
    {
      public:
        ...
        static void register_global_method(rttr::string_view name, Func func, rttr::string_view category = "",
        ...
        static void register_member_method(rttr::string_view class_name, rttr::string_view name, Func func,
                                           rttr::string_view category = "", rttr::string_view description = "",
